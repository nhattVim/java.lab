...
public class StringMethodExample {
    ...
    public void demostrateStringMethod(){
        ...
        System.out.println("------some string method------");
        ...
        System.out.println("Replace word: " + targetString.replace("fun", "easy"));
        ...
        System.out.println("Search s1 in targetString: " + targetString.contains(s1));
        System.out.println("Search s2 in targetString: " + targetString.contains(s2));
